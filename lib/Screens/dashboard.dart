...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    List<icon> iconList = icon.iconList;
      ...
      body: Stack(
        children: [
          Positioned(
              bottom: height * .4,
              child: Container(
                  width: width, height: height * .6, color: Color(0xffdbe9f7)
                  //Color(0xff2A2C28),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text('Welcome,Dhruv!',
                        style:
                            TextStyle(color: Color(0xff0391C6), fontSize: 35))
                  ],
                ),
                          ...
                          child: Padding(
                              ...
                              child: Stack(children: [
                                CircleAvatar(
                                  ...
                                  //Colors.white70,
                                  radius: width * .1,
                                  child: Image.asset(iconList[index].imageURL),
                                ),
                              ])),
                        );
                      }),
                        ...
                        return GestureDetector(
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => DetailPage(
                                          offerId: offerList[index].offerId,
                                        )));
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius:
                                  BorderRadius.circular(width * 0.0486),
                            ),
                            child: Stack(
                              children: [
                                // Positioned(
